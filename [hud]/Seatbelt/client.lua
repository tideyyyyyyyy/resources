      ...
      if IsControlJustReleased(0, Config.Control) and GetLastInputMethod(0) then
          ...
          Citizen.Wait(1)
            ...
            if Config.Notification then
              TriggerEvent("mole_notifications:SendNotification", {text = "Cinturon puesto", type = "success", timeout = 2400})
            end
            ...
            if Config.Notification then
            TriggerEvent("mole_notifications:SendNotification", {text = "Cinturon quitado", type = "error", timeout = 2400})
            end
